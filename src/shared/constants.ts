/**
 * A1111 sampler name → equivalent names in other UIs (ComfyUI et al).
 * Vendored from the civitai app's samplerMap so cross-format sampler
 * normalization behaves identically.
 */
export const samplerMap: ReadonlyMap<string, string[]> = new Map<string, string[]>([
